...
class curry_menu3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_curry_menu3)
        //recyclerView = findViewById();
        curry3_textView3.text = "[1 단계]. 재료 손질"	// TextView 세팅
        curry3_textView4.text = "햄, 양파, 당근 모든 재료를 \n 한입 크기로 썰어 줍니다."	// TextView 세팅


        //인텐트 넘기기
        curry3_button2.setOnClickListener {
            if(flag == 1){
                val intent = Intent(this, curry_menu4::class.java)
        ...
        timerTask = kotlin.concurrent.timer(period = 1000) {	// timer() 호출
            ...
            // UI조작을 위한 메서드
            runOnUiThread {
                curry3_textView5.text = "$a : $b"	// TextView 세팅
                curry3_textView6.text = "$c : $d"	// TextView 세팅
            }
