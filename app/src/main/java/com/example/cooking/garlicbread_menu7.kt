...
import kotlinx.android.synthetic.main.activity_garlicbread_menu6.*
import kotlinx.android.synthetic.main.activity_garlicbread_menu7.*
import java.util.*
import kotlin.math.ceil

class garlicbread_menu7 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_garlicbread_menu7)
        //인텐트 받기
        ...
        //인텐트 넘기기
        garlicbread7_button2.setOnClickListener {
            if (flag == 1) {
                val intent = Intent(this, garlicbread_menu8::class.java)
        ...
        garlicbread7_textView3.text = "[5 단계]. 플래이팅"    // TextView 세팅 8글자 넘어가면 넘어가버림.
        garlicbread7_textView4.text = "눌러 붙지 않게 저으면서 \n 끓여주면 완성입니다."
        ...
        timerTask = kotlin.concurrent.timer(period = 1000) {    // timer() 호출
            ...
            runOnUiThread {
                ...
                bb1 = secsec + sec
                garlicbread7_textView5.text = "$a : $bb"    // TextView 세팅
                garlicbread7_textView6.text = "$c : $d"    // TextView 세팅
            }
