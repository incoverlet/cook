...
class curry_menu6 : AppCompatActivity() {
    @RequiresApi(Build.VERSION_CODES.N)
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_curry_menu6)
        //인텐트 받기
        ...
        //인텐트 넘기기
        curry6_button2.setOnClickListener {
            if (flag == 1) {
                val intent = Intent(this, curry_menu7::class.java)
        ...
        curry6_textView3.text = "[5 단계]. 플래이팅"    // TextView 세팅 8글자 넘어가면 넘어가버림.
        curry6_textView4.text = "눌러 붙지 않게 저으면서 \n 끓여주면 완성입니다."
        ...
        timerTask = kotlin.concurrent.timer(period = 1000) {    // timer() 호출
            ...
            runOnUiThread {
                ...
                bb1 = secsec + sec
                curry6_textView5.text = "$a : $bb"    // TextView 세팅
                curry6_textView6.text = "$c : $d"    // TextView 세팅
            }
