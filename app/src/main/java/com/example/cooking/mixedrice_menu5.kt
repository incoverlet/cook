...
import kotlinx.android.synthetic.main.activity_mixedrice_menu5.*
import java.util.*
...
class mixedrice_menu5 : AppCompatActivity() {
    @RequiresApi(Build.VERSION_CODES.N)
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_mixedrice_menu5)
        //인텐트 받기
        ...
        //인텐트 넘기기
        mixedrice5_button2.setOnClickListener {
            if(flag == 1){
        ...
        mixedrice5_textView3.text = "[4 단계]. 카레가루 넣고 끓이기"	// TextView 세팅 8글자 넘어가면 넘어가버림.
        mixedrice5_textView4.text = "카레가루 넣고\n 잘 저어가며 중간불로 끓여줍니다."
        ...
        timerTask = kotlin.concurrent.timer(period = 1000) {	// timer() 호출
            ...
            runOnUiThread {
                ...
                bb1 = secsec + sec
                mixedrice5_textView5.text = "$a : $bb"	// TextView 세팅
                mixedrice5_textView6.text = "$c : $d"	// TextView 세팅
            }
