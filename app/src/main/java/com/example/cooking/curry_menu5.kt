...
import kotlinx.android.synthetic.main.activity_curry_menu4.*
import kotlinx.android.synthetic.main.activity_curry_menu5.*
import java.util.*
...
class curry_menu5 : AppCompatActivity() {
    @RequiresApi(Build.VERSION_CODES.N)
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_curry_menu5)
        //인텐트 받기
        ...
        //인텐트 넘기기
        curry5_button2.setOnClickListener {
            if(flag == 1){
                val intent = Intent(this, curry_menu6::class.java)
        ...
        curry5_textView3.text = "[4 단계]. 카레가루 넣고 끓이기"	// TextView 세팅 8글자 넘어가면 넘어가버림.
        curry5_textView4.text = "카레가루 넣고\n 잘 저어가며 중간불로 끓여줍니다."
        ...
        timerTask = kotlin.concurrent.timer(period = 1000) {	// timer() 호출
            ...
            runOnUiThread {
                ...
                bb1 = secsec + sec
                curry5_textView5.text = "$a : $bb"	// TextView 세팅
                curry5_textView6.text = "$c : $d"	// TextView 세팅
            }
