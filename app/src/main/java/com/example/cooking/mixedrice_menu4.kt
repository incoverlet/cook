...
import kotlinx.android.synthetic.main.activity_mixedrice_menu4.*
import java.util.*
...
class mixedrice_menu4 : AppCompatActivity() {
    @RequiresApi(Build.VERSION_CODES.N)
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_mixedrice_menu4)
        //인텐트 받기
        ...
        //인텐트 넘기기
        mixedrice4_button2.setOnClickListener {
            if (flag == 1) {
        ...
        mixedrice4_textView3.text = "[3 단계]. 재료 볶기"    // TextView 세팅 8글자 넘어가면 넘어가버림.
        mixedrice4_textView4.text = "파와 양파의 향이 올라오면\n 당근과 햄을 볶다가\n  소금과 후추를 넣고" +
                "간을 해줍니다."
        ...
        timerTask = kotlin.concurrent.timer(period = 1000) {    // timer() 호출
            ...
            runOnUiThread {
                ...
                bb1 = secsec + sec
                mixedrice4_textView5.text = "$a : $bb"    // TextView 세팅
                mixedrice4_textView6.text = "$c : $d"    // TextView 세팅
            }
